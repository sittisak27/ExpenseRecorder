...
# Help
def About():
  messagebox.showinfo('About','สวัสดีครับโปรแกรมนี้คือโปรแกรมบันทึกข้อมูล')
...
icon_T1 = PhotoImage(file='t1_expand.png') #.subsample(2) = ย่อรูป
icon_T2 = PhotoImage(file='t2_expand.png')
...
B2 = ttk.Button(F1,text='Save',command=Save,image=icon_b1,compound='left')
...
#   resulttable.headeing(header[i],text=head[i])
